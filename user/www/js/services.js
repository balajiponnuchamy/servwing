...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://servwing-ffbb5.firebaseio.com/"),
    refCart = new Firebase("https://servwing-ffbb5.firebaseio.com/cart"),
    refUser = new Firebase("https://servwing-ffbb5.firebaseio.com/users"),
    refCategory = new Firebase("https://servwing-ffbb5.firebaseio.com/category"),
    refOrder = new Firebase("https://servwing-ffbb5.firebaseio.com/orders"),
    refFeatured = new Firebase("https://servwing-ffbb5.firebaseio.com/featured"),
    refMenu = new Firebase("https://servwing-ffbb5.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
